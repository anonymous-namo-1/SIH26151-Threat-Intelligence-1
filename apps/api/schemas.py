...
ENTITY_TYPES = Literal["ACTOR_HYPOTHESIS", "PERSONA", "USERNAME", "EMAIL", "PGP_KEY", "CRYPTO_WALLET", "DOMAIN", "IP_ADDRESS", "ONION_SERVICE", "URL", "POST", "MESSAGE", "DOCUMENT", "MARKETPLACE", "FORUM", "ORGANIZATION", "INFRASTRUCTURE", "FILE_HASH", "CRYPTO_TRANSACTION", "LOCATION_INDICATOR", "DEVICE_INDICATOR"]
